...
import MultipleInputArea from "./MultipleInputArea";
import intolerances from "../datas/intolerances";
...
export default () => {
    ...
    return(
            <View style = { tw`h-full overflow-hidden`}>
                ...
                <ScrollView style = {tw`h-5/6 flex flex-col rounded-md border w-1/2 self-center my-20 p-5`}>
                    <View>
                        ...
                        <View style = {tw`px-0 pt-5`}>    
                            ...
                            <View style = {tw`py-1`}>
                                ...
                                <View>
                                    <View style = { tw`flex flex-col` }>
                                        ...
                                        <MultipleInputArea 
                                            Inputs = { inputs } 
                                            onChangeInputs = { inputs => setInputs( inputs ) } 
                                            inputsData = { intolerances }
                                        />
                                    </View>
                                    <View style = {tw`py-1`}>
                                        <Text style = {tw`text-lg text-left`}>
                            ...
                            :
                            <DatePicker
                                options={{...tw``,textSecondaryColor : 'rgb(249,115,22)', mainColor : 'rgb(249,115,22)'}}
                                mode = "datepicker"
