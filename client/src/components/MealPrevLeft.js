...
export default () => {
    return <View style={tw`w-1/3 h-full`}>
        ...
        <View style={{...tw` w-full px-20`}} >
            ...
            <Text style={{...tw `px-3`, fontSize: 15 }} > Temps de préparation : {previewMeal["readyInMinutes"]} min </Text>
            <Text style={{...tw `px-3`, fontSize: 15 }} > Coût de préparation : {previewMeal["pricePerServing"]} $ </Text>
